"""Assemble the four native jobs' named assets and an aggregate checksum file."""
...
def collect(source: Path, output: Path, version: str) -> None:
...
if __name__ == "__main__":
    ...
    collect(args.source, args.output, args.version)
